...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
    ...
    //metode onCreateViewHolder, adapter akan membuat ViewHolder baru untuk setiap item dalam RecyclerView
    // berdasarkan layout yang ditentukan dalam file XML item_user.
    @NonNull
    @Override
    ...
    public void onBindViewHolder(@NonNull UserAdapter.ViewHolder holder, int position) {
        ...
        // Dengan menggunakan kode ini, ketika pengguna mengklik profil, username,
        // atau nama di item RecyclerView, akan membuka ProfileActivity dengan objek model yang sesuai
