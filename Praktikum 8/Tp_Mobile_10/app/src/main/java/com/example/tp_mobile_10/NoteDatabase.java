...
public class NoteDatabase extends SQLiteOpenHelper {
    ...
    //onUpgrade(), kita menjalankan perintah execSQL() pada sqLiteDatabase untuk menjalankan
    // perintah SQL yang diberikan.
    ...
    //metode insertNote() yang digunakan untuk menyisipkan (insert) data catatan ke dalam tabel
    // "note_table" dalam database.
    ...
    // metode getAllNote() yang digunakan untuk mengambil semua data catatan dari tabel "note_table" dalam database.
    public Cursor getAllNote(){
        return db.query(table_note, null, null, null, null, null, title + " ASC");
    }

    //metode getNote(),mengambil data catatan dari tabel "note_table" dalam database berdasarkan ID catatan tertentu dan menggunakan objek Cursor untuk menelusuri hasilnya.
    public Cursor getNote(long id){
        return db.rawQuery("select * from " + table_note + " where " + id_note + "=" + id, null);
    }

    // metode searchNotes() yang digunakan untuk mencari catatan dalam tabel "note_table" berdasarkan suatu query tertentu.
