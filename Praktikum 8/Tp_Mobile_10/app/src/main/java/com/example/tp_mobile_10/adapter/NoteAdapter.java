...
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.NoteViewHolder>{
    ...
    public void onBindViewHolder(@NonNull NoteViewHolder holder, int position) {
        ...
        @SuppressLint("Range") String time = cursor.getString(cursor.getColumnIndex(NoteDatabase.time));
        @SuppressLint("Range") String description = cursor.getString(cursor.getColumnIndex(NoteDatabase.description));

        @SuppressLint("Range") long id = cursor.getLong(cursor.getColumnIndex(NoteDatabase.id_note));
    ...
    } //getCount() mengembalikan jumlah baris (item) dalam cursor.
    ...
    //Metode swapCursor() digunakan ketika ingin mengubah sumber data yang ditampilkan dalam RecyclerView.
